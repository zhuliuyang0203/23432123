...
[JsonSerializable(typeof(Modules.CloseCommand), TypeInfoPropertyName = "Browser_CloseCommand")]
[JsonSerializable(typeof(Modules.CreateUserContextCommand))]
[JsonSerializable(typeof(Modules.GetUserContextsCommand))]
[JsonSerializable(typeof(Modules.GetUserContextsResult))]
[JsonSerializable(typeof(Modules.RemoveUserContextCommand))]
[JsonSerializable(typeof(Modules.GetClientWindowsCommand))]
[JsonSerializable(typeof(Modules.GetClientWindowsResult))]
[JsonSerializable(typeof(Modules.SetClientWindowStateCommand))]
[JsonSerializable(typeof(Modules.UserContextInfo))]
[JsonSerializable(typeof(IReadOnlyList<Modules.UserContextInfo>))]
[JsonSerializable(typeof(IReadOnlyList<Modules.ClientWindowInfo>))]
