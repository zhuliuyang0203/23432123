 ...
 * </code></pre>
 */
public class OperaOptions extends ChromiumOptions<OperaOptions> {

  /**
   * Key used to store a set of OperaOptions in a {@link org.openqa.selenium.Capabilities}
   * object.
   */
  public static final String CAPABILITY = "opera:operaOptions";

  public OperaOptions() {
    super(CapabilityType.BROWSER_NAME, OPERA.browserName(), CAPABILITY);
