...
public class v131Target implements org.openqa.selenium.devtools.idealized.target.Target {
  ...
  public Command<Void> detachFromTarget(
    ...
    return Target.detachFromTarget(
        sessionId.map(
            id -> new org.openqa.selenium.devtools.v131.target.model.SessionID(id.toString())),
        targetId.map(
            id -> new org.openqa.selenium.devtools.v131.target.model.TargetID(id.toString())));
  }
  ...
  public Command<SessionID> attachToTarget(TargetID targetId) {
    Function<JsonInput, org.openqa.selenium.devtools.v131.target.model.SessionID> mapper =
        ConverterFunctions.map(
            "sessionId", org.openqa.selenium.devtools.v131.target.model.SessionID.class);

    return new Command<>(
        "Target.attachToTarget",
        Map.of(
            "targetId",
            new org.openqa.selenium.devtools.v131.target.model.TargetID(targetId.toString()),
            "flatten",
            true),
        input -> {
  ...
  public Event<TargetID> detached() {
    return new Event<>(
        ...
        input -> {
          Function<JsonInput, org.openqa.selenium.devtools.v131.target.model.TargetID> converter =
              ConverterFunctions.map(
                  "targetId", org.openqa.selenium.devtools.v131.target.model.TargetID.class);
