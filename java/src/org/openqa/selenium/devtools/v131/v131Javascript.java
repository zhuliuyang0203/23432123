...
import org.openqa.selenium.devtools.v131.page.model.ScriptIdentifier;
...
public class v131Javascript extends Javascript<ScriptIdentifier, BindingCalled> {

  public v131Javascript(DevTools devtools) {
    super(devtools);
  }
