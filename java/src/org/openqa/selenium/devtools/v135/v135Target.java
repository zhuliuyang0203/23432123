...
import org.openqa.selenium.devtools.v135.target.Target;
import org.openqa.selenium.devtools.v135.target.model.TargetInfo;
import org.openqa.selenium.json.JsonInput;
import org.openqa.selenium.json.TypeToken;

public class v135Target implements org.openqa.selenium.devtools.idealized.target.Target {
  ...
  public Command<Void> detachFromTarget(
    ...
    return Target.detachFromTarget(
        sessionId.map(
            id -> new org.openqa.selenium.devtools.v135.target.model.SessionID(id.toString())),
        targetId.map(
            id -> new org.openqa.selenium.devtools.v135.target.model.TargetID(id.toString())));
  }
  ...
  public Command<SessionID> attachToTarget(TargetID targetId) {
    Function<JsonInput, org.openqa.selenium.devtools.v135.target.model.SessionID> mapper =
        ConverterFunctions.map(
            "sessionId", org.openqa.selenium.devtools.v135.target.model.SessionID.class);

    return new Command<>(
        "Target.attachToTarget",
        Map.of(
            "targetId",
            new org.openqa.selenium.devtools.v135.target.model.TargetID(targetId.toString()),
            "flatten",
            true),
        input -> {
          org.openqa.selenium.devtools.v135.target.model.SessionID id = mapper.apply(input);
  ...
  public Event<TargetID> detached() {
    return new Event<>(
        ...
        input -> {
          Function<JsonInput, org.openqa.selenium.devtools.v135.target.model.TargetID> converter =
              ConverterFunctions.map(
                  "targetId", org.openqa.selenium.devtools.v135.target.model.TargetID.class);
