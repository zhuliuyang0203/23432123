 ...
 * reference is still valid. This essentially determines whether the element is
 * still attached to the DOM. If this test fails, then an
...
public interface WebElement extends SearchContext, TakesScreenshot {
     ...
     *
     * <p>
     * See <a href="https://w3c.github.io/webdriver/#element-click">W3C
     ...
     *
     * <p>
     * See <a href="https://w3c.github.io/webdriver/#element-clear">W3C
     * WebDriver specification</a>
     * and
    ...
    /**
     * Get the value of the given property of the element. Will return the
     ...
     *
     * <p>
     * This method, unlike {@link #getAttribute(String)}, returns the value of
     * the attribute with the given name but not the property with the same
     * name.
     *
     * <p>
     ...
     * representation with a trailing semicolon.
     *
     * <p>
     * The following are deemed to be "boolean" attributes, and will return
     * either "true" or null:
     ...
     * precise, use {@link #getDomAttribute(String)} or
     ...
     * {@link #getDomProperty(String)} or {@link
    ...
    /**
     * Determine whether this element is selected or not. This operation only
     * applies to input elements such as checkboxes, options in a select and
     * radio buttons. For more information on which elements this method
     * supports, refer to the <a
     ...
     *
     * <p>
     * See <a href="https://w3c.github.io/webdriver/#get-element-text">W3C
     * WebDriver specification</a> for more details.
     *
     ...
     * <p>
     * See
     * <a href="https://w3c.github.io/webdriver/#find-elements-from-element">W3C
     * WebDriver specification</a> for more details.
     *
     ...
     * #findElements(By)} about finding via XPath. This method is affected by
     ...
     *
     * <p>
     * findElement should not be used to look for non-present elements, use {@link
     * #findElements(By)} and assert zero length response instead.
     *
     * <p>
     * See
     * <a href="https://w3c.github.io/webdriver/#find-element-from-element">W3C
     * WebDriver specification</a> for more details.
     *
    ...
    /**
     * @return A representation of an element's shadow root for accessing the
    ...
    /**
     * Get the value of a given CSS property. Color values could be returned as
     * rgba or rgb strings. This depends on whether the browser omits the
     * implicit opacity value or not.
     *
     * <p>
     * For example if the "background-color" property is set as "green" in the
     * HTML source, the returned value could be "rgba(0, 255, 0, 1)" if implicit
     * opacity value is preserved or "rgb(0, 255, 0)" if it is omitted.
     *
     * <p>
     * Note that shorthand CSS properties (e.g. background, font, border,
     * border-top, margin, margin-top, padding, padding-top, list-style,
     * outline, pause, cue) are not returned, in accordance with the <a
     * href="http://www.w3.org/TR/DOM-Level-2-Style/css.html#CSS-CSSStyleDeclaration">DOM
     * CSS2 specification</a> - you should directly access the longhand
